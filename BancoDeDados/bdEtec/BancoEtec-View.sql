...
--a) Criar uma view vwSaldoTotal obtendo o nome do correntista, o saldo da Conta corrente, o Saldo da Poupança e a soma dos dois saldos --OK
...
--b)Utilizando a view vwSaldoTotal anterior, ordenar os correntistas por ordem alfabética --OK
...
--c)Criar uma view vwProjecaoSaldoPoupanca informando o nome do correntista e o saldo da poupança atualizado após acréscimo de 0.5% no próximo mês --Não sei se ta certo
...
--d)Criar uma view vwExibeCorrentista que exiba todos os dados da conta corrente ao lado do nome do correntista (exceto a senha numérica e alfanumérica),
--com a data de abertura da conta corrente no formato dd/mm/aaaa e o saldo da poupança
