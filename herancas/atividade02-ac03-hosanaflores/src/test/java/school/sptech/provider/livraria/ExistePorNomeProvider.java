...
public class ExistePorNomeProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Livraria SPTech", List.of(), "O Senhor dos Anéis", false),
        Arguments.of("Livraria SPTech", List.of(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16), "O Senhor dos Anéis", true),
        Arguments.of("Livraria SPTech", List.of(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16), "O Hobbit", true),
        Arguments.of("Livraria SPTech", List.of(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16), "O Silmarillion", true),
        Arguments.of("Livraria SPTech", List.of(j2, j3, j4, j5, j6, j7, j8, j9, j10), "War", false),
        Arguments.of("Livraria SPTech", List.of(j1, j2, j3, j4, j5, j6, j7, j8, j9, j10), "War", true),
        Arguments.of("Livraria SPTech", List.of(j1, j2, j3, j4, j5, j6, j7, j8, j9, j10), "Banco Imobiliário", true)
    );
  }
}
