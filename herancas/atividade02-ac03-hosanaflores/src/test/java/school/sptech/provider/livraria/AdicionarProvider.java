...
public class AdicionarProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
      Arguments.of("Livraria SPTech", List.of(), l1, List.of(l1)),
      Arguments.of("Livraria SPTech", List.of(l1), l2, List.of(l1, l2)),
      Arguments.of("Livraria SPTech", List.of(l1, l2), l3, List.of(l1, l2, l3)),
      Arguments.of("Livraria SPTech", List.of(l1, l2, l3), l4, List.of(l1, l2, l3, l4)),
      Arguments.of("Livraria SPTech", List.of(l1, l2, l3, l4), l5, List.of(l1, l2, l3, l4, l5)),
      Arguments.of("Livraria SPTech", List.of(l1, l2, l3, l4, l5), j1, List.of(l1, l2, l3, l4, l5, j1))
    );
  }
}
