...
public class CalcularTotalLivrosProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Livraria SPTech", List.of(), 0.0),
        Arguments.of("Livraria SPTech", List.of(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16), 2113.0),
        Arguments.of("Livraria SPTech", List.of(j1, j2, j3, j4, j5, j6, j7, j8, j9, j10), 0.0),
        Arguments.of("Livraria SPTech", List.of(l1, j1, l2, j2, l3, j3, l4, j4, l5, j5, l6, j6, l7, j7, l8, j8), 1218.0),
        Arguments.of("Livraria SPTech", List.of(l1, j1, l2, j2, l3, j3, l4, j4, l5, j5, l6, j6, l7, j7, l8, j8, l9, l10, l11, l12, l13, l14, l15, l16, j9, j10), 2113.0)
    );
  }
}
