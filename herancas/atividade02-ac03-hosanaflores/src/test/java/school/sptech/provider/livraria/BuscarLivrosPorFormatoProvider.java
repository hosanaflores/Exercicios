...
public class BuscarLivrosPorFormatoProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        ...
        Arguments.of("Livraria SPTech", List.of(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16), "COMUM", List.of(l2, l3, l4, l5, l6, l7, l8)),
        Arguments.of("Livraria SPTech", List.of(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16), "DIGITAL", List.of(l9, l10, l11, l14, l15, l16)),
        Arguments.of("Livraria SPTech", List.of(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16), "CAPA_DURA", List.of(l1, l12, l13)),
        Arguments.of("Livraria SPTechs", List.of(j1, j2, j3, j4, j5, l5, l6, l7, l8, l9, l10), "COMUM", List.of(l5, l6, l7, l8)),
        Arguments.of("Livraria SPTech", List.of(j1, j2, j3, j4, j5, j6, j7, j8, j9, j10), "CAPA_DURA", List.of()),
        Arguments.of("Livraria SPTech", List.of(j1, j2, j3, j4, j5, j6, j7, j8, j9, j10), "CAPA_DURA", List.of())
    );
  }
}
