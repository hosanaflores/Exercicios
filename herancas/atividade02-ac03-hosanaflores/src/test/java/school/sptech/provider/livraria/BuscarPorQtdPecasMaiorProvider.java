...
public class BuscarPorQtdPecasMaiorProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Livraria SPTech", List.of(), 10, List.of()),
        Arguments.of("Livraria SPTech", List.of(l1, j1, l2, j2, l3, j3, l4, j4, l5, j5, l6, j6, l7, j7, l8, j8), 50, List.of(j1, j3, j4, j6)),
        Arguments.of("Livraria SPTech", List.of(l1, j1, l2, j2, l3, j3, l4, j4, l5, j5, l6, j6, l7, j7, l8, j8), 100, List.of()),
        Arguments.of("Livraria SPTech", List.of(l1, j1, l2, j2, l3, j3, l4, j4, l5, j5, l6, j6, l7, j7, l8, j8), 20, List.of(j1, j2, j3, j4, j5, j6, j7)),
        Arguments.of("Livraria SPTech", List.of(l1, j1, l2, j2, l3, j3, l4, j4, l5, j5, l6, j6, l7, j7, l8, j8), 90, List.of(j1)),
        Arguments.of("Livraria SPTech", List.of(l1, j1, l2, j2, l3, j3, l4, j4, l5, j5, l6, j6, l7, j7, l8, j8), 300, List.of())
    );
  }
}
