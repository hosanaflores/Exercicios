...
import school.sptech.provider.retangulo.CalcularAreaProvider;
...
public class RetanguloTest {
  ...
  class MetodoCalcularAreaTest {
    ...
    void test1(String cor, Integer espessura, Double base, Double altura, Double expected) throws ReflectiveOperationException {
      ...
      // Case
      Object obj = RetanguloFactory.build(cor, espessura, base, altura);

      // When
      Object resposta = metodo.invoke(obj);

      // Then
      assertAll(() -> assertEquals(expected, (Double) resposta, 0.01, "calcularArea deve calcular corretamente a área do retângulo"));
    }
  }
}
