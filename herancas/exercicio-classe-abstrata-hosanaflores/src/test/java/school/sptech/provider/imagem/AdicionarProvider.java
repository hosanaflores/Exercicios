...
public class AdicionarProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        ...
        Arguments.of(List.of(d1), d2, List.of(d1, d2)),
        Arguments.of(List.of(d1, d2), d3, List.of(d1, d2, d3)),
        Arguments.of(List.of(d1, d2, d3), d4, List.of(d1, d2, d3, d4)),
        Arguments.of(List.of(d1, d2, d3, d4), d5, List.of(d1, d2, d3, d4, d5)),
        Arguments.of(List.of(d1, d2, d3, d4, d5), d6, List.of(d1, d2, d3, d4, d5, d6))
    );
  }
}
