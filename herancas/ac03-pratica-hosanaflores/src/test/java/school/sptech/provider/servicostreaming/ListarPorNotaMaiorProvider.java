...
public class ListarPorNotaMaiorProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Netflix", List.of(), 9.0, List.of()),
        Arguments.of("Netflix", List.of(f1), 9.0, List.of(f1)),
        Arguments.of("Netflix", List.of(f1, f2), 9.0, List.of(f1)),
        Arguments.of("Netflix", List.of(f1, f9, f3), 9.4, List.of(f1)),
        Arguments.of("Netflix", List.of(f1, f2, f3, f4), 8.0, List.of(f1, f2, f3, f4)),
        Arguments.of("Netflix", List.of(s1), 9.0, List.of(s1)),
        Arguments.of("Netflix", List.of(s1, s2), 9.0, List.of(s1, s2)),
        Arguments.of("Netflix", List.of(s1, s2, s3), 9.0, List.of(s1, s2)),
        Arguments.of("Netflix", List.of(s1, s2, s3, s4), 9.0, List.of(s1, s2)),
        Arguments.of("Netflix", List.of(s1, s2, s3, s4, s10), 9.0, List.of(s1, s2))
    );
  }
}
