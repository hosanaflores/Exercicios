...
public class AdicionarProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Netflix", List.of(), f1, List.of(f1)),
        Arguments.of("Netflix", List.of(f1), f2, List.of(f1, f2)),
        Arguments.of("Netflix", List.of(f1, f2), f3, List.of(f1, f2, f3)),
        Arguments.of("Netflix", List.of(f1, f2, f3), f4, List.of(f1, f2, f3, f4)),
        Arguments.of("Netflix", List.of(f1, f2, f3, f4), f5, List.of(f1, f2, f3, f4, f5)),
        Arguments.of("Netflix", List.of(), s1, List.of(s1)),
        Arguments.of("Netflix", List.of(s1), s2, List.of(s1, s2)),
        Arguments.of("Netflix", List.of(s1, s2), s3, List.of(s1, s2, s3)),
        Arguments.of("Netflix", List.of(s1, s2, s3), s4, List.of(s1, s2, s3, s4)),
        Arguments.of("Netflix", List.of(s1, s2, s3, s4), s5, List.of(s1, s2, s3, s4, s5)),
        Arguments.of("Netflix", List.of(), f1, List.of(f1)),
        Arguments.of("Netflix", List.of(f1), s1, List.of(f1, s1)),
        Arguments.of("Netflix", List.of(f1, s1), f2, List.of(f1, s1, f2)),
        Arguments.of("Netflix", List.of(f1, s1, f2), s2, List.of(f1, s1, f2, s2)),
        Arguments.of("Netflix", List.of(f1, s1, f2, s2), f3, List.of(f1, s1, f2, s2, f3))
    );
  }
}
