...
public class ListarPorGeneroProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Netflix", List.of(), "DRAMA", List.of()),
        Arguments.of("Netflix", List.of(f1), "DRAMA", List.of(f1)),
        Arguments.of("Netflix", List.of(f1, f2), "DRAMA", List.of(f1, f2)),
        Arguments.of("Netflix", List.of(f1, f9, f3), "DRAMA", List.of(f1, f3)),
        Arguments.of("Netflix", List.of(f1, f2, f3, f4), "COMEDIA", List.of()),
        Arguments.of("Netflix", List.of(f1, f2, f3, f4, f10), "TERROR", List.of()),
        Arguments.of("Netflix", List.of(s1), "DRAMA", List.of(s1)),
        Arguments.of("Netflix", List.of(s1, s2), "DRAMA", List.of(s1, s2)),
        Arguments.of("Netflix", List.of(s1, s2, s3), "TERROR", List.of(s3)),
        Arguments.of("Netflix", List.of(s1, s2, s3, s4), "TERROR", List.of(s3, s4)),
        Arguments.of("Netflix", List.of(s1, s2, s3, s4, s10), "TERROR", List.of(s3, s4, s10))
    );
  }
}
