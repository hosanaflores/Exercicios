...
public class CalcularTotalProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Paulo", "PENDENTE", List.of(i1, i2, i3), 20.0, 205.0),
        Arguments.of("Pedro", "PENDENTE", List.of(i4, i5, i6), 5.0, 277.0),
        Arguments.of("Bianca", "PENDENTE", List.of(i1), 10.0, 80.0),
        Arguments.of("Maria", "PENDENTE", List.of(i1, i6), 3.0, 225.0),
        Arguments.of("João", "PENDENTE", List.of(i2, i5), 15.0, 140.0),
        Arguments.of("Lucas", "PENDENTE", List.of(i3, i4), 5.1, 122.0)
    );
  }
}
