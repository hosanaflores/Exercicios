...
public class GetTotalSalariosProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Consultoria 1", 10, List.of(d1, d2, d3, d4, d5), 11395.3),
        Arguments.of("Consultoria 2", 10, List.of(d6, d7, d8, d9, d10), 34387.5),
        Arguments.of("Consultoria 3", 10, List.of(d11, d12, d13, d14, d15), 25023.19),
        Arguments.of("Consultoria 4", 10, List.of(d1, d6, d7, d11, d12), 26198.19),
        Arguments.of("Consultoria 5", 10, List.of(d5, d10, d15), 15883.9)
    );
  }
}
