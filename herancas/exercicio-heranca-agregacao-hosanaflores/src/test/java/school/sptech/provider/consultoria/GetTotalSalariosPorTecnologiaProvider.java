...
public class GetTotalSalariosPorTecnologiaProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Consultoria 1", 10, List.of(d1, d2, d3, d4, d5), "MySQL", 0.0),
        Arguments.of("Consultoria 2", 10, List.of(d6, d7, d8, d9, d10), "MySQL", 15716.4),
        Arguments.of("Consultoria 3", 10, List.of(d11, d12, d13, d14, d15), "iOS", 15048.19),
        Arguments.of("Consultoria 4", 10, List.of(d1, d6, d7, d11, d12), "Django", 14262.8),
        Arguments.of("Consultoria 5", 10, List.of(d5, d10, d15), "Spring Boot", 0.0)
    );
  }
}
